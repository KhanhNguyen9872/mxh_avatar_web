...
?>
<div class="lucifer"><b>Chọn loại đồ muốn mua : </b><select name="url"size="1"onChange="window.open(this.options [this.selectedIndex].value,'_top')" style="border: 0;">
<?php
...
echo '<option value="?loai=non"> Nón</option>';
?>
</select>
...
echo '<div class="list1"><button name="submit" class="btn btn-danger"><i class="fa fa-usd" aria-hidden="true"></i> Mua <i class="fa fa-usd" aria-hidden="true"></i></button></div>';
}
echo '</form>';
if ($total > $kmess) {
echo '<div class="topmenu">' . functions::display_pagination('/shop/gift.php?', $start, $total, $kmess) . '</div>';
}
