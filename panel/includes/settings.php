...
if (isset($_POST['submit'])) {
    ...
    */
    ...
    mysql_query("UPDATE `cms_settings` SET `val`='" . intval($_POST['khuyenmai']) . "' WHERE `key` = 'khuyenmai'");
...
echo '<p>' .
    ...
    'Khuyến mãi nạp' . ':<br/>' . '<input name="khuyenmai" size="1" value="' . $set['khuyenmai'] . '"/>%<br />' .
