...
if ($total) {
    if ($total > $kmess) echo '<div class="phantrang">' . functions::display_pagination('index.php?act=files&amp;', $start, $total, $kmess) . '</div>';
...
if ($total > $kmess) {
    echo '<div class="phantrang">' . functions::display_pagination('index.php?act=files&amp;', $start, $total, $kmess) . '</div>';
