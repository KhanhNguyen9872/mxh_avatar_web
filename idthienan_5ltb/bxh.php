...
echo'<div><div class="da"><div class="phdr">Bảng Xếp Hạng |<a href="/idthienan_5ltb"> Trở Về Làng</a></div>';

$req = mysql_query("SELECT * FROM `tuipkm1` WHERE `id` ORDER BY `lv`  DESC LIMIT 5");
