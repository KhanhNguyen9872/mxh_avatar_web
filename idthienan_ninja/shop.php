...
$shop1 = mysql_fetch_array(mysql_query("SELECT * FROM `shoppkm` WHERE `id`='1'"));
$shop2 = mysql_fetch_array(mysql_query("SELECT * FROM `shoppkm` WHERE `id`='2'"));
$shop3 = mysql_fetch_array(mysql_query("SELECT * FROM `shoppkm` WHERE `id`='3'"));
$shop4 = mysql_fetch_array(mysql_query("SELECT * FROM `shoppkm` WHERE `id`='4'"));
$shop5 = mysql_fetch_array(mysql_query("SELECT * FROM `shoppkm` WHERE `id`='5'"));
$shop6 = mysql_fetch_array(mysql_query("SELECT * FROM `shoppkm` WHERE `id`='6'"));
$shop7 = mysql_fetch_array(mysql_query("SELECT * FROM `shoppkm` WHERE `id`='7'"));
