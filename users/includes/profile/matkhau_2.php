...
switch ($mod) {
        ...
        */
        ...
        if (!$error) {
      	...
      	echo '<div class="mainblok">';
            echo functions::display_error($error, '<a href="/users/profile.php?act=matkhau_2&amp;user=' . $user['id'] . '">' . $lng['repeat'] . '</a>');
        }
        break;
    ...
    default:
        ...
        */
        ...
        echo '<form action="/users/profile.php?act=matkhau_2&amp;mod=change&amp;user=' . $user['id'] . '" method="post">';
        if ($user['id'] == $user_id)
