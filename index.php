...
error_reporting (0);
/**
* @develo[er     ID Thiên Ân
* @sinh năm        2k5 - wtf!!
* @copyright   ID Thiên Ân - Copyright (C) 2008-2011 JohnCMS Community
* @version    source avatar 4rum - free
* @facebook   fb.com/idthienan
*/
...
$headmod = 'error404';
$textl = 'Lỗi địa chỉ';
$mota = 'Bạn đã truy cập lỗi địa chỉ';
require('incfiles/head.php');
echo'<div class="phdr">Lỗi đường dẫn</div><div class="menu"><b>Địa chỉ không khả dụng hoặc đã bị xóa nhấn vào đây để về </br><a href="/"><span class="red">Trang chủ</span></a></b></div>';
break;
